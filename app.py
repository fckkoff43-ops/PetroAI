...
.footer{{border-top:1px solid #20252a;margin-top:28px;padding-top:12px;color:#78838f;font-size:11px}}
...
if page=='Dashboard':
    ...
    if st.button('🔥 Generate PDF Report',use_container_width=True):
        try:
            pdf=make_pdf();st.success('✅ PDF report berhasil dibuat!');st.download_button('⬇️ Download PetroAI Engineering Report',pdf.getvalue(),'PetroAI_Engineering_Report.pdf','application/pdf',use_container_width=True)
