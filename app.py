...
.hero{{min-height:155px;border:1px solid rgba(79,127,158,.4);border-radius:10px;overflow:hidden;background-image:linear-gradient(90deg,rgba(10,14,19,.97),rgba(10,14,19,.82) 38%,rgba(10,14,19,.35) 78%,rgba(10,14,19,.75)),url('{uri}');background-size:cover;background-position:center;margin-bottom:14px}}
...
st.markdown('<div class="hero"><div class="hero-inner"><div>🛢️ Welcome to</div><h1>Petro<span>AI</span> Analyzer</h1><p>Analyze well production performance, identify water-related risks, and get petroleum engineering recommendations from production data.</p><div class="tag">Smarter Analysis. Better Decisions. Higher Production.</div><div><span class="asset">🏗️ Offshore Rig</span><span class="asset">⬆️ SRP</span><span class="asset">🏭 Production Facility</span><span class="asset">🔩 Wellhead</span></div></div></div>',unsafe_allow_html=True)
